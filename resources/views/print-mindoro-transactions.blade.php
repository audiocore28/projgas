	...
	<div style="font: 9px sans-serif;" class="row">
		<div class="column-l">
			...
			@foreach ($monthlyTransactions['mindoro_transactions'] as $transaction)
				...
				<?php $output = $total_transactions_amount - $total_load_amount - $transaction['expense'] - $transaction['driver_salary'] - $transaction['helper_salary'] - $transaction['commission'] ?>
		...
		<div class="row" style="margin-top: 5px">
			...
			<div class="column-r" style="margin-top: 15px;">
				<table class='table' width="40%" cellspacing='0' cellpadding='5' style="margin-top: 5px">
					...
					<tr>
						<td align="right" style="font-weight: bold; background-color: #eee;"> {{ number_format($total_transactions_amount - $total_load_amount - $transaction['expense'] - $transaction['driver_salary'] - $transaction['helper_salary'] - $transaction['commission']) }} </td>
					</tr>
				</table>
			</div>
		</div>
