  ...
  <div>
    ...
    <div class="p-1">
      <ul class="flex border-b">
        <li @click="openTab = 2" :class="{ '-mb-px': openTab === 2 }" class="mr-1" v-show="supplier.purchases.length">
      ...
      <div class="w-full pt-4">
        <div v-show="openTab === 2">
          <purchases :purchaseDetails="supplier.purchases" record="suppliers"></purchases>
        </div>
