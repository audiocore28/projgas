    ...
    <div class="p-1">
      <ul class="flex border-b">
        <li @click="openTab = 1" :class="{ '-mb-px': openTab === 1 }" class="-mb-px mr-1">
          <a :class="openTab === 1 ? activeClasses : inactiveClasses" class="bg-white inline-block py-2 px-4 font-semibold" href="#">Edit Hauling</a>
        </li>
...
import HaulCreateForm from '@/Shared/HaulCreateForm'
...
export default {
  ...
  methods: {
    ...
    onSearchPurchaseChange: throttle(function(term) {
      this.$inertia.get(this.route('hauls.edit'), {term}, {
        preserveState: true,
        preserveScroll: true,
        replace: true,
      })
