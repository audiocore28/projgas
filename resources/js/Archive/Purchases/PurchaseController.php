...
class PurchaseController extends Controller
{
    ...
    public function update(UpdatePurchaseRequest $request, Purchase $purchase)
    {
        ...
        foreach($request->details as $detail)
        {
            $purchase = $purchase->purchaseDetails()->findOrNew($detail['id']);

            // 'purchase_id' => $detail['purchase_id'],
            $purchase->product_id = $detail['product']['id'];
            $purchase->quantity = $detail['quantity'];
            $purchase->unit_price = $detail['unit_price'];
            $purchase->remarks = $detail['remarks'];
        ...
        foreach($request->tankerLoads as $load)
        {
            $load = $load->tankerLoadDetails()->findOrNew($load['id']);
